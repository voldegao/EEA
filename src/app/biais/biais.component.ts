  ...
  httpOptions = {
    ...
    getdata(){
      ...
      postData.append('dateFin',this.dateFin);
       this.http.post<any>('https://8000-aqua-silverfish-gv5meqbl.ws-eu16.gitpod.io/api/biais?page='+this.currentpage, postData, this.httpOptions).map(res => res).subscribe(data => {
        console.log(data);
       this.data = data.data
