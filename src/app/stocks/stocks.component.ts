 ...
 public showgraphArticle = (code): void => {
  ...
  getdatagraph(code){
      ...
      postData.append('code',code);
       this.http.post<any>('https://8000-aqua-silverfish-gv5meqbl.ws-eu16.gitpod.io/api/stocks?page=1', postData, this.httpOptions).map(res => res).subscribe(data => {
...
articleDataDetail: any
    ...
    getdataArticleDetails(){
      ...
      postData.append('code',this.articleCodeID);
       this.http.post<any>('https://8000-aqua-silverfish-gv5meqbl.ws-eu16.gitpod.io/api/mad?page=1', postData, this.httpOptions).map(res => res).subscribe(data => {
