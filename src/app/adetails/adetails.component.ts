...
export class AdetailsComponent implements OnInit {
  ...
  public confirmBtnClick = (id): void => {
    ...
    deleteCause(){
      ...
      this.http.post<any>('https://8000-aqua-silverfish-gv5meqbl.ws-eu16.gitpod.io/api/article/causes/delete', postData, this.httpOptions).map(res => res).subscribe(data => {
        if(data){
          this.closeConfirm()
    ...
    editCause(id){
      ...
      this.theCauseID = id
      this.http.get<any>('https://8000-aqua-silverfish-gv5meqbl.ws-eu16.gitpod.io/api/article/cause/info/'+id, this.httpOptions).map(res => res).subscribe(data => {
        console.log(data)
   ...
   getFamilles(){
     this.http.get<any>('https://8000-aqua-silverfish-gv5meqbl.ws-eu16.gitpod.io/api/familles', this.httpOptions).map(res => res).subscribe(data => {
      this.familles = data
...
this.chartData2 = [
 ...
 getArticles(){
    ...
    this.http.post<any>('https://8000-aqua-silverfish-gv5meqbl.ws-eu16.gitpod.io/api/famille/articles', postData, this.httpOptions).map(res => res).subscribe(data => {
 ...
 getArticledata(){
  this.resetChart()
    ...
    this.http.post<any>('https://8000-aqua-silverfish-gv5meqbl.ws-eu16.gitpod.io/api/biais', postData, this.httpOptions).map(res => res).subscribe(data => {
...
articleID: any 
  ...
  validateCause(){
      ...
      if(this.causeEditStat == true){
        ...
        this.http.post<any>('https://8000-aqua-silverfish-gv5meqbl.ws-eu16.gitpod.io/api/article/causes/update/'+this.theCauseID, postData, this.httpOptions).map(res => res).subscribe(data => {
            console.log(data)
            this.getcauses(this.articleID)
        ...
        this.http.post<any>('https://8000-aqua-silverfish-gv5meqbl.ws-eu16.gitpod.io/api/article/causes/create', postData, this.httpOptions).map(res => res).subscribe(data => {
            console.log(data)
            this.getcauses(this.articleID)
            this.formShow = false
            }, err => {
  ...
  getcauses(id){
    ...
    let postData = new FormData();
      postData.append('datedebut',this.dateDebut);
      postData.append('datefin',this.dateFin)
    this.http.post<any>('https://8000-aqua-silverfish-gv5meqbl.ws-eu16.gitpod.io/api/article/causes/'+id,postData, this.httpOptions).map(res => res).subscribe(data => {
      console.log(data)
